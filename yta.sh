...
# Ask user to enter atempo filter value (e.g., 1.5 - 150%)
read -p "Enter the atempo filter value (e.g., 1.5): " atempo_value

# Ask user to enter output MP3 file name (e.g., file_name)
read -p "Enter the output MP3 file name (e.g., file_name): " mp3_file_name
